                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="<?php echo site_url('caretaker_c/add_caretaker') ?>">
								  <div style="margin-left:17%; color:red;"><span class="font"><?php echo validation_errors(); ?> </span></div>
                                      ...
                                      <div class="form-group">
                                          <div class="col-lg-offset-2 col-lg-10">
                                              ...
                                              <a class="btn btn-default" href="<?php echo site_url('account_c/caretaker');?>" type="button">Cancel</a>
                                          </div>
                                      </div>
                                  </form>
                              </div>
